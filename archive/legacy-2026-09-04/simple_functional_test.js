...
try {
    ...
    // 检查关键功能
    const checks = [
        { name: 'StorageManager类', content: generatorContent, pattern: 'class StorageManager' },
        { name: 'MonthlyReportGenerator类', content: generatorContent, pattern: 'class MonthlyReportGenerator' },
        { name: 'MonthlyReportConfigUI类', content: uiContent, pattern: 'class MonthlyReportConfigUI' },
        { name: 'MonthlyReportUI类', content: uiContent, pattern: 'class MonthlyReportUI' },
        { name: '自动生成功能', content: generatorContent, pattern: 'autoGenerate' },
        { name: '手动生成功能', content: generatorContent, pattern: 'manualGenerate' },
        { name: '配置管理功能', content: generatorContent, pattern: 'config' },
        { name: '历史记录功能', content: generatorContent, pattern: 'history' },
...
try {
    ...
    const htmlChecks = [
        ...
        { name: '配置按钮', pattern: 'config-button' },
        { name: '模态框', pattern: 'modal' },
...
try {
    ...
    const testChecks = [
        ...
        { name: '断言函数', pattern: 'assert' },
        { name: '测试运行器', pattern: 'runTests' },
        { name: '测试结果', pattern: '测试总结' }
    ];
